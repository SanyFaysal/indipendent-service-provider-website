...
const Service = ({ service }) => {
    ...
    return (
        <div className='col col-xl-3 col-lg-3 col-md-4 col-sm-10 col-10 shadow rounded-2 d-inline w-full m-3 px-4 py-2'>
            <h4 className='text-center text-bold   mt-0'>{name}</h4>
            <div className='d-flex justify-content-center mb-3' >
                <img src={img} style={{ width: '200px', height: '200px', borderRadius: '10px' }} alt="" />
            </div>
            <p className='my-1'>
